...
import TesteRuller from '../../../components/Teste/TesteRuller';

let gAtletaID = 1;

class RullerTaf extends Component {
    constructor(props) {
    ...
    render() {
        const atletas = this.state.atletas.map(row => <TesteRuller teste={row} HandleAtleta={this.onChangeSelectAtletaValue} />);
            ...
            <div className="Wells">
                ...
                <div role="main" className="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-2 border-bottom">
                        <h2 className="h2">Aplicar Teste da queda de Ruller (Tempo de Reação)</h2>
                    </div>
